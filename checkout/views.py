...
def checkout(request):
    ...
    if request.method == 'POST':
            ...
            for item_id, item_data in list(bag.items()):
                ...
                try:
                    ...
                    messages.error(request, (
                        "The product you requested was not found in our database - Please email the team for assistance!"))
                    order.delete()
        ...
        bag = request.session.get('bag', {})
        if not bag:
            messages.error(request, "There are cuttenly no products in your bag")
